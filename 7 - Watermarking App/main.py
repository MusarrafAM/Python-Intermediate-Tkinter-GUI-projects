...
def font_func(event):
    global FONT_NAME
    font_dict = {"Arial": "arial", "Arial Italic": "ariali", "Arial Bold": "arialbd", "Arial Black": "ariblk",
                 "Impact": "impact",
                 "Script MT Bold": "SCRIPTBL", "Calibri": "calibri", "Calibri Italic": "calibrii",
...
def about():
    tkinter.messagebox.showinfo(title="About",
                                message="Desktop Watermark App 1.0\n\nFree to share\n\nCreated by\nMusarraf\n2023.")
...
def confirm():
    ...
    if img == None:
        ...
        # textwidth, textheight = draw.textbbox((0,0), text, font)
...
# get first 3 letters of every month name
color_cb['values'] = ['black', 'gray', 'brown', 'blue', 'purple', 'green', 'red', 'orange', 'yellow', 'white', 'silver',
                      'gold']
# prevent typing a value
